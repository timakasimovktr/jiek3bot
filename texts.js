const texts = {
  ru: {
    ...
    group_join_prompt: "📌 Н а ж м и т е  к н о п к у:",
    ...
    cancel_confirm: "⁉️ Вы хотите отменить заявку?",
    ...
    group_button: (colony) => `🫂 ${colony}-я ${colony === "23" ? "МУИК" : "ЖИЭК"} группа`,
    moneyGroup: "Группа денежных переводов",
    ...
    attemptsLeft: (attempts) => `✅ У Вас ${attempts == 2 ? "осталось " : "осталась"} ${attempts} ${attempts == 2 ? "(две) " : "(одна)"} ${attempts == 2 ? "попытки " : "попытка"}.`,
    cancel_application_attempts: "💵 Следующая попытка будет платной!",
    continue: "Продолжить",
  ...
  uz: {
    ...
    group_join_prompt: "📌 Т у г м а с и н и  б о с и н г:",
    ...
    cancel_confirm: "⁉️ Аризани бекор қилмоқчимисиз?",
    ...
    group_button: (colony) => `🫂 ${colony}-сон ${colony === "23" ? "МУИК" : "ЖИЭК"} гуруҳи`,
    moneyGroup: "Пул ўтказмалари гуруҳи",
    ...
    cancel_application_attempts: "💵 Кейинги уриниш пулли бўлади!",
  ...
  uzl: {
    ...
    group_join_prompt: "📌 T u g m a s i n i  b o s i n g:",
    ...
    cancel_confirm: "⁉️ Arizani bekor qilmoqchimisiz?",
    ...
    group_button: (colony) => `🫂 ${colony}-son ${colony === "23" ? "MUIK" : "JIEK"} guruhi`,
    ...
    cancel_application_attempts: "💵 Keyingi urinish pulli bo‘ladi!",
