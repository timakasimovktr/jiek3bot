const texts = {
  ru: {
    ...
    please_pay: "Для этой колонии требуется оплата. Сумма: 1000 сум.",
    pay_button: "Оплатить",
  ...
  uz: {
    ...
    please_pay: "Бу колония учун to'lov talab qilinadi. Miqdor: 1000 so'm.",
    pay_button: "То'лов қилиш",
    check_status: "То'лов ҳолатини текшириш",
    payment_success: "То'лов муваффақиятли амалга оширилди!",
    payment_failed: "То'лов амалга оширилмади.",
    payment_not_confirmed: "То'лов ҳали тасдиқланмади. Илтимос, кейинроқ текширинг.",
  },
  uzl: {
    ...
    please_pay: "Bu koloniya uchun to'lov talab qilinadi. Miqdor: 1000 so'm.",
